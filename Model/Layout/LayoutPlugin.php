...
namespace Alkahf\PerformanceDashboard\Model\Layout;
...
class LayoutPlugin
{
    ...
    /** @var \Alkahf\PerformanceDashboard\Logger\Logger */
    private $logger;
     ...
     * @param \Alkahf\PerformanceDashboard\Logger\Logger $logger
     */
    public function __construct(
        \Magento\PageCache\Model\Config $config,
        \Magento\Framework\App\RequestInterface $request,
        \Magento\Framework\Filesystem\DirectoryList $directoryList,
        \Alkahf\PerformanceDashboard\Logger\Logger $logger
    ) {
        $this->config = $config;
