...
namespace MNShuhailey\PerformanceDashboard\Block\Backend\Dashboard\Grid\Column;
 ...
 *
 * @package MNShuhailey\PerformanceDashboard\Block\Backend\Dashboard\Grid\Column
 */
class Statuses extends \Magento\Backend\Block\Widget\Grid\Column
{
    ...
    public function decorateStatus($value, $row, $column, $isExport)
    {
        ...
        $severity = [
            \MNShuhailey\PerformanceDashboard\Model\DashboardRow::STATUS_OK => 'notice',
            \MNShuhailey\PerformanceDashboard\Model\DashboardRow::STATUS_WARNING => 'minor',
            \MNShuhailey\PerformanceDashboard\Model\DashboardRow::STATUS_PROBLEM => 'critical',
            \MNShuhailey\PerformanceDashboard\Model\DashboardRow::STATUS_UNKNOWN => 'minor'
        ];
