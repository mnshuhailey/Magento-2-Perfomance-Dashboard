...
namespace MNShuhailey\PerformanceDashboard\Model\Layout;
...
class LayoutPlugin
{
    ...
    /** @var \MNShuhailey\PerformanceDashboard\Logger\Logger */
    private $logger;
     ...
     * @param \MNShuhailey\PerformanceDashboard\Logger\Logger $logger
     */
    public function __construct(
        \Magento\PageCache\Model\Config $config,
        \Magento\Framework\App\RequestInterface $request,
        \Magento\Framework\Filesystem\DirectoryList $directoryList,
        \MNShuhailey\PerformanceDashboard\Logger\Logger $logger
    ) {
        $this->config = $config;
